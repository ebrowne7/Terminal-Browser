export const NETWORK_CONFIG = {
  ...
  '10.0.8.12': { hostname: 'OPEN-PROXY-SG', baseTraceRate: 0, isProxyable: true, ports: [80, 1080, 8080] },
  '10.0.8.21': { hostname: 'OPEN-PROXY-CA', baseTraceRate: 0, isProxyable: true, ports: [443, 8080] },
  '10.0.8.34': { hostname: 'OPEN-PROXY-BR', baseTraceRate: 0, isProxyable: true, ports: [80, 3128] },
  '10.0.8.55': { hostname: 'OPEN-PROXY-NO', baseTraceRate: 0, isProxyable: true, ports: [443, 1080] },
...
export const DEFAULT_FILES = {
  ...
  '10.0.8.2': [
    { path: '/var/tmp/relay-map.txt', content: 'Additional relays:\n - 10.0.8.9\n - 10.0.8.12\n - 10.0.8.21' }
  ],
  '10.0.8.9': [
    { path: '/var/tmp/relay-map.txt', content: 'Deep relays:\n - 10.0.8.34\n - 10.0.8.55' }
  ],
  '10.0.99.1': [
